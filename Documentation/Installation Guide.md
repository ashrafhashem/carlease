...
More information on the configuration file can be found in [Server Side.md](/Documentation/Server%20Side.md)
...
1. Perform the steps mentioned above in (Updating the configurations file)
2. go to the folder containing the project and execute "node app.js"
    
 
You can then view it by opening your browser to where you have NodeJS running. 
